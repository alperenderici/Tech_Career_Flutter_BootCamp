...
<h3 align="center">Tech Career Flutter BootCamp</h3>
  ...
  <p align="center">
    ...
    <br />
    ·
    <a href="https://github.com/alperenderici/Tech_Career_Flutter_BootCamp/tree/main/flutter_bootcamp/lib/sessions">Course Sessions</a>
    ·
    <a href="https://github.com/alperenderici/Tech_Career_Flutter_BootCamp/tree/main/flutter_bootcamp/lib/homeworks">Homeworks</a>
  </p>
</div>
 ...
 <li>
    ...
    <li>
      ...
      <ul>
       ...
       <li><a href="#list-products-by-filters">List Products by Filters</a></li>
        <li><a href="#add-delete-basket">Add-Delete Basket</a></li>
       <li><a href="#basket">Decrease-increase the number of product in the basket.</a></li>
       <li><a href="#price">Total Basket Price</a></li>
       <li><a href="#fav">Add-Remove Favourite</a></li>
      </ul>
    </li>
...
## Built With [![Flutter][Flutter.js]][Flutter-url]

* [flutter_bloc][flutter_bloc-url]
* [dio][dio-url]
* [path][path-url]
* [Lottie][lottie-url]
* [flutter_lorem][flutter_lorem-url]

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## Details

The webservices (API) links gives the dataset as a JSON (Adding-deleting food to the cart)(Bring all the food)(Bring the food in the basket)(Getting pictures of the food). I prefered to use dio package and get, post methods for the webservice requests.
...
* [Kasım Adalan](linkedin.com/in/kasım-adalan)
...
[path-url]: https://pub.dev/packages/path
[flutter_lorem-url]: https://pub.dev/packages/flutter_lorem
[lottie-url]: https://pub.dev/packages/lottie
